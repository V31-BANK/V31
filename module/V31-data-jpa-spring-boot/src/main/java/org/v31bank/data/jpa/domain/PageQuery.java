 ...
 * <p>
 * Query objects are expected to extend this class with their own filter fields and
 * convert to a Spring Data {@link Pageable} via {@link #toPageable()}.
 *
 * @author Xander Wang
 * @since 0.2.0
 */
public class PageQuery {
	 ...
	 * one-based page number to Spring Data's zero-based index and clamping the page size
