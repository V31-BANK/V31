...
public class LedgerAccountController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<LedgerAccountResponse>> create(@Valid @RequestBody LedgerAccountRequest request) {
		ApiResponse<LedgerAccount> result = this.ledgerAccountInputPort.create(request.code(), request.name(),
				request.type());
		if (!result.success()) {
	...
	public ApiResponse<PageResponse<LedgerAccountResponse>> page(LedgerAccountPageQuery query) {
		PageResult<LedgerAccountResponse> page = this.ledgerAccountInputPort.page(query)
	...
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponse<LedgerAccountResponse>> update(@PathVariable UUID id,
	...
	private static ResponseEntity<ApiResponse<LedgerAccountResponse>> toResponseEntity(
			ApiResponse<LedgerAccount> result) {
