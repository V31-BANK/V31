 ...
 * <p>
 * The JPA services extend {@code org.v31bank.data.jpa.domain.PageQuery}, which converts
 * itself into a Spring Data {@code Pageable}. This service has no Spring Data on its
 * classpath, so the pagination request is carried here and handed to {@code JooqPages},
 * which clamps it and turns it into a limit and an offset.
 *
 * @author Xander Wang
 * @since 0.2.0
 */
