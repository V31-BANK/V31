 ...
 * <p>
 * Registering an address is the moment an operator can still stop a mistake:
 * once a withdrawal is broadcast to it, nothing recalls it. That is why an
 * address arrives {@code PENDING} and has to be approved before it can be used.
 * @author Xander Wang
 * @since 0.2.0
 */
@Entity
