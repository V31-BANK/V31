...
public class ComplianceCaseController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<ComplianceCaseResponse>> create(@RequestBody ComplianceCaseRequest request) {
    ...
    /**
     * Return a page of cases, newest first. Pass {@code customerId},
     * {@code status}, {@code type} or {@code caseNumber} to narrow it.
    ...
    public ResponseEntity<ApiResponse<ComplianceCaseResponse>> update(@PathVariable UUID id,
            @RequestBody ComplianceCaseRequest request) {
    ...
    /**
     * Answer a delete with the envelope carrying the case that was removed, rather
