...
/**
 * Output port for {@link NotificationTemplate} persistence, implemented by the infrastructure
 * layer.
 *
 * @author Xander Wang
 * @since 0.2.0
...
public interface NotificationTemplatePort {
     ...
     */
    PageResult<NotificationTemplate> findPage(NotificationTemplatePageQuery query);
