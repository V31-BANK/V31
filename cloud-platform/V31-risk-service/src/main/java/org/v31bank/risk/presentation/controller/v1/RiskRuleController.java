...
public class RiskRuleController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<RiskRuleResponse>> create(@RequestBody RiskRuleRequest request) {
        ApiResponse<RiskRule> result = this.riskRuleInputPort.create(request.code(), request.name(), request.severity());
        if (!result.success()) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<RiskRuleResponse>> update(@PathVariable UUID id, @RequestBody RiskRuleRequest request) {
